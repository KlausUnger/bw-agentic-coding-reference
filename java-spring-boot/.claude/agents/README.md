...
| **feature-implementer** | TDD implementation | Opus | Code, tests, `.scratch/implementation-plan.md` |
| **code-quality-reviewer** | Readability, Java style | Sonnet | `.scratch/reviews/code-quality.md` |
